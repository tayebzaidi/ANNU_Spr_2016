function [t,x]=rkf45(f,intervalo,x0,N)

% La funci�n rkf45 resuelve un problema de valor inicial de la forma
%  x'=f(t,x) en [t0,T]
%  x(t0)=x0
% con x0 en R^n, mediante el m�todo adaptativo de Runge-Kutta-Fehlberg.
%
% ENTRADA:
%  f=@func: funci�n f definida en el fichero func.m con dos argumentos de entrada: 
...
%
% SALIDA:
%  t: vector de abscisas donde se va a aproximar la soluci�n con N+1 componentes
